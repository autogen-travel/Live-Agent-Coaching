...
async function authorize(options) {
    const openid = await Promise.resolve().then(() => __importStar(require("openid-client")));
    const parseBody = await Promise.resolve().then(() => __importStar(require("co-body")));
    ...
    if (responseType === "fragment" && typeof callbackResult === "string") {
        parameters = Object.fromEntries(new URLSearchParams(callbackResult.slice(1)));
    }
