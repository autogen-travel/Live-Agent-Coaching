...
exports.runGptEmulation = runGptEmulation;
...
*/
async function runGptEmulation(request, count, options) {
    var _a, _b, _c;
    ...
    const api = new rest.GptEmulationApi(account, log);
    const response = await api.Emulate(request, count);
    return (_c = (_b = response.choises) === null || _b === void 0 ? void 0 : _b.map((x) => { var _a; return ({ error: x.error, gptResponse: ((_a = x.gptResponse) !== null && _a !== void 0 ? _a : []) }); })) !== null && _c !== void 0 ? _c : [];
}
