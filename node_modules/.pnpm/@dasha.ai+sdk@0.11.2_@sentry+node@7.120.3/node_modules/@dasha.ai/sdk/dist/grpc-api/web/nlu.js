...
const nlu_service_grpc_pb = __importStar(require("./generated/nlu-service_grpc_web_pb"));
...
class NluServiceClient extends base.Client {
    constructor(account, log) {
        super(nlu_service_grpc_pb.NluServiceClient, account, log.child({ ...log.defaultMeta, service: "nlu" }));
    }
    train(nluContent, language) {
        return new base.Stream((stream) => {
            const trainRequest = new nlu_service_pb.TrainRequest();
            trainRequest.setDataset(nluContent);
