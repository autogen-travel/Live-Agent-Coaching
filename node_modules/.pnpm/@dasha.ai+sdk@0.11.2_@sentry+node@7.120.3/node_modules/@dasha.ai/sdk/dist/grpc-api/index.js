...
exports.createNluServiceClient = exports.createProcessingClient = exports.createMultichannelTextProtocolClient = exports.createTextProtocolClient = exports.createExternalTtsClient = exports.textProtocol = exports.externalTtsProtocol = exports.processing = void 0;
...
const createExternalTtsClient = async (account, log) => {
    switch (await getGrpc()) {
        ...
        case Grpc.NotImplemented:
            (0, log_1.logAndThrow)(log, new errors.NotImplementedError("grpc is not implemented ExternalTtsClient"));
    }
};
...
const createTextProtocolClient = async (account, log) => {
    switch (await getGrpc()) {
        ...
        case Grpc.NotImplemented:
            (0, log_1.logAndThrow)(log, new errors.NotImplementedError("grpc is not implemented TextProtocolClient"));
    }
};
exports.createTextProtocolClient = createTextProtocolClient;
const createMultichannelTextProtocolClient = async (account, log) => {
    switch (await getGrpc()) {
        case Grpc.Node: {
            const { MultiChannelTextProtocolClient } = await Promise.resolve().then(() => __importStar(require("./node/multichannel-text-protocol")));
            return new MultiChannelTextProtocolClient(account, log);
        }
        case Grpc.Web: {
            const { MultiChannelTextProtocolClient } = await Promise.resolve().then(() => __importStar(require("./web/multichannel-text-protocol")));
            return new MultiChannelTextProtocolClient(account, log);
        }
        case Grpc.NotImplemented:
            (0, log_1.logAndThrow)(log, new errors.NotImplementedError("grpc is not implemented TextProtocolClient"));
...
exports.createMultichannelTextProtocolClient = createMultichannelTextProtocolClient;
const createProcessingClient = async (account, log) => {
    switch (await getGrpc()) {
        ...
        case Grpc.NotImplemented:
            (0, log_1.logAndThrow)(log, new errors.NotImplementedError("grpc is not implemented ProcessingClient"));
    }
};
