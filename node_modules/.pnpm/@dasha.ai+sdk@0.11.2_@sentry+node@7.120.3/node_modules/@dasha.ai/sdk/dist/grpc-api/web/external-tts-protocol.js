...
const external_tts_grpc_pb = __importStar(require("./generated/external-client-tts_grpc_web_pb"));
...
class ExternalTtsClient extends base.Client {
    constructor(account, log) {
        super(external_tts_grpc_pb.ExternalClientTtsProtocolClient, account, log.child({ ...log.defaultMeta, service: "tts" }));
    }
        ...
        return new base.Stream((stream) => {
            ...
            grpcStream.on("data", (grpcMessage) => {
                ...
                if (voiceInfo === undefined)
                    (0, log_1.logAndThrow)(this.log, new errors.InternalError());
                let options = {};
                if ((voiceInfo === null || voiceInfo === void 0 ? void 0 : voiceInfo.options) !== undefined && (voiceInfo === null || voiceInfo === void 0 ? void 0 : voiceInfo.options) !== null && (voiceInfo === null || voiceInfo === void 0 ? void 0 : voiceInfo.options) !== "") {
                    try {
                        options = (_a = JSON.parse(voiceInfo.options)) !== null && _a !== void 0 ? _a : {};
                    }
                    catch (e) {
                        options = {};
                    }
                }
                const preparedVoiceInfo = { ...voiceInfo, ...{ options: options } };
                stream.emit("request", { requestId, messageId, text, voiceInfo: preparedVoiceInfo });
            });
            return grpcStream;
        }, this.log.child({
