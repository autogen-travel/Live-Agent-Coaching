...
class ConversationRejectedError extends Error {
    constructor(data, jobId, jobKey) {
        super(`conversation[Id:${jobId}][Key:${jobKey}] rejected: ${data.reason}`);
        this.data = data;
...
class SipConfigDuplicateError extends Error {
    constructor(msg) {
        super(`Found duplicate. Reason: ${msg}`);
        this.msg = msg;
        this.name = "dasha.SipConfigDuplicateError";
    }
}
exports.SipConfigDuplicateError = SipConfigDuplicateError;
...
class NluServiceError extends Error {
    constructor(message) {
        super(`NLU service error: ${message}`);
        this.name = "dasha.NluServiceError";
    }
}
exports.NluServiceError = NluServiceError;
class NluServiceTrainFailedError extends NluServiceError {
    constructor(message) {
        super(`NLU service training error: ${message}`);
        this.name = "dasha.NluServiceError";
    }
}
exports.NluServiceTrainFailedError = NluServiceTrainFailedError;
class SdkObserverError extends Error {
    constructor(message) {
        super(`Sdk observer error: ${message}`);
        this.name = "dasha.SdkObserverError";
    }
}
exports.SdkObserverError = SdkObserverError;
