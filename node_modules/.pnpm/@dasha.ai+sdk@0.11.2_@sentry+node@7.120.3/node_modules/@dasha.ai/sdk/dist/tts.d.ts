...
import { ListOptions, TtsCloneResponseDto } from "./rest-api/generated/core";
import { ClonePatchDto, CloneRequest } from "./rest-api/tts";
/**
 ...
 */
export type TtsProviderName = "default" | "custom" | "dasha";
/**
 ...
 */
export type TtsDispatcher<TInput extends Record<string, unknown>, TOutput extends Record<string, unknown>> = (conv: Conversation<TInput, TOutput>) => TtsProviderName | Promise<TtsProviderName>;
/**
 ...
 * ```
 */
export type CustomTtsProvider = (text: string, voice: {
    speaker: string;
    lang: string;
    emotion?: string;
    speed?: number;
...
export declare function cloneAsync(request: CloneRequest, audios: Array<any>, options: {
    account?: Account;
}): Promise<TtsCloneResponseDto>;
export declare function deleteCloneAsync(id: string, options: {
    account?: Account;
}): Promise<void>;
export declare function updateCloneAsync(id: string, dto: ClonePatchDto, options: {
    account?: Account;
}): Promise<TtsCloneResponseDto>;
export declare function listVoicesAsync(filter: ListOptions, options: {
    account?: Account;
}): Promise<TtsCloneResponseDto[]>;
