...
const loadProfile = async (request, options) => {
    var _a;
    ...
    const logger = log_1.log.child({ account: (0, account_1.anonymizeAccount)(account) });
    ...
    await api.generate(request, cancelToken);
    percent = 33;
    onProgress === null || onProgress === void 0 ? void 0 : onProgress({
        severity: "info",
        percent,
        description: "Profile is generating...",
        scopes: ["profiler"],
    });
    cancelToken === null || cancelToken === void 0 ? void 0 : cancelToken._throwIfCanceled(logger);
    let polls = 1;
    let isGenerated = await api.isAvailableToDownload(request, cancelToken);
    while (!isGenerated) {
        onProgress === null || onProgress === void 0 ? void 0 : onProgress({
            severity: "info",
            percent,
        ...
        cancelToken === null || cancelToken === void 0 ? void 0 : cancelToken._throwIfCanceled(logger);
        isGenerated = await api.isAvailableToDownload(request, cancelToken);
        polls++;
    }
    percent = 66;
    onProgress === null || onProgress === void 0 ? void 0 : onProgress({
    ...
    cancelToken === null || cancelToken === void 0 ? void 0 : cancelToken._throwIfCanceled(logger);
    const buffer = await api.download(request, cancelToken, (loaded, total) => {
        onProgress === null || onProgress === void 0 ? void 0 : onProgress({
            severity: "info",
