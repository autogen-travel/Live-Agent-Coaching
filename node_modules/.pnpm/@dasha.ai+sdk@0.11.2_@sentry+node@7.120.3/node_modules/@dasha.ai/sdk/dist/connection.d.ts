 ...
 * ```
 */
export type ConnectionProvider<TInput extends Record<string, unknown>, TOutput extends Record<string, unknown>> = (conv: Conversation<TInput, TOutput>) => Connection | Promise<Connection>;
/**
