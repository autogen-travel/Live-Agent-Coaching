...
async function toInboundConfig(dto, groupApi) {
    ...
    return {
        ...
        uri: dto.uri,
        alias: (_b = dto.alias) !== null && _b !== void 0 ? _b : undefined,
        aliasUri: (_c = dto.aliasUri) !== null && _c !== void 0 ? _c : undefined
    };
}
/**
 ...
 *   defaults to the {@link getCurrentAccountName | current account}
 *
 * @returns {@link InboundConfig} object
 */
async function getConfigByName(name, options) {
    ...
    const endpointApi = new rest.SipEndpointApi(account, log);
    const groupApi = new rest.GroupApi(account, log);
    const config = await endpointApi.getConfigByName(name);
