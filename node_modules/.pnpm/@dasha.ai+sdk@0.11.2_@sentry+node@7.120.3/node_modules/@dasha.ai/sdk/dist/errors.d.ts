...
export declare class ConversationRejectedError extends Error {
    data: Record<string, unknown>;
    name: string;
    constructor(data: Record<string, unknown>, jobId: string, jobKey: string);
}
...
export declare class SipConfigDuplicateError extends Error {
    msg: string;
    name: string;
...
export declare class NluServiceError extends Error {
    name: string;
    constructor(message: string);
}
export declare class NluServiceTrainFailedError extends NluServiceError {
    name: string;
    constructor(message: string);
}
export declare class SdkObserverError extends Error {
    name: string;
    constructor(message: string);
}
