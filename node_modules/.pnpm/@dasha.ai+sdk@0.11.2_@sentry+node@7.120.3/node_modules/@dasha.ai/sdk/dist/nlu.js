...
class NluService {
    ...
    static async create(nluContent, language, options = {}) {
        ...
        nluClient.account = (_a = options.account) !== null && _a !== void 0 ? _a : (await (0, account_1._getEffectiveAccount)({ _log: log_1.log }));
        nluClient.log = log_1.log.child({ account: (0, account_1.anonymizeAccount)(nluClient.account) });
    ...
    async recognize(text) {
        ...
        const languageToSkills = (0, lodash_1.groupBy)(Object.values(this.skillInfo), (skillInfo) => skillInfo.language);
        const results = { v1: {} };
    ...
    async loadSkills(skills) {
        const languageToRequestedSkills = (0, lodash_1.groupBy)(skills, (skillInfo) => skillInfo.language);
        const notFoundIds = [];
        for (const lang of Object.keys(languageToRequestedSkills)) {
            ...
            const foundIds = (0, lodash_1.intersection)(requiredIds, availableIds);
            notFoundIds.push(...(0, lodash_1.difference)(requiredIds, foundIds));
        }
    ...
    async train(contentOrPath, language) {
        ...
        if (typeof contentOrPath === "string") {
            ...
            try {
                const file = await fs_1.default.promises.readFile(nluDatasetPath, "utf8");
                // checking valid json file
                JSON.parse(file);
                nluContent = Buffer.from(file);
            }
            catch (e) {
            ...
            nluContent = Buffer.from(JSON.stringify(contentOrPath));
        }
        ...
        const result = {
            v1: {
                data: (_b = (_a = recognitionResponse.v1) === null || _a === void 0 ? void 0 : _a.dataRecognitionsList.map((dataRec) => {
                    return {
                        type: "data",
                        data: Object.fromEntries(dataRec.dataMap),
