...
async function deploy(pathOrZip, options) {
    ...
    const accountLog = log_1.log.child({ account: (0, account_1.anonymizeAccount)(account) });
    ...
    const applicationZip = typeof pathOrZip === "string" ? await zip.application(pathOrZip, customerLog) : pathOrZip;
    return await application_1.Application._deploy({
        ...
        axios: (options === null || options === void 0 ? void 0 : options.axios) !== undefined ? options.axios : (0, http_1.createAxiosInstance)({}, applicationLog, (error, retryCount) => {
            applicationLog.error(`Failed to do HTTP Request ${error.code} ${error.status}`);
