...
function _guessFormatFromMime(mime) {
    switch (mime) {
        ...
        case "audio/L16":
            return "pcm16";
        default:
            (0, log_1.logAndThrow)(log_1.log, new errors.AudioError(`mime type not supported: ${mime}`));
    }
}
function _guessFormatFromExtension(path) {
    ...
    switch (extension) {
        ...
        case "mp3":
            return "mp3";
        default:
            (0, log_1.logAndThrow)(log_1.log, new errors.AudioError(`cannot guess file format from extension: ${extension}`));
    }
}
/**
...
async function fromFile(path, format) {
    return new Audio(format !== null && format !== void 0 ? format : _guessFormatFromExtension(path), await fs_1.default.promises.readFile(path));
}
//#endregion
/**
